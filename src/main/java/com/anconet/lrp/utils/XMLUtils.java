...
public class XMLUtils {
	...
	private static void readSettings(Element settings, ConfigurationItem configurationItem) {
		...
		configurationItem.setDefaultUserAgentHeader(new BasicHeader("User-Agent", settings.getChildText("defaultuseragent")));
	...
	private static void readRadioStations(Element radiostations, ConfigurationItem configurationItem) throws MalformedURLException {
		...
		for (Element e : radioStationElements) {
			...
			Header userAgent = e.getChildText("user-agent") != null
					? new BasicHeader("User-Agent", e.getChildText("user-agent")) : configurationItem.getDefaultUserAgentHeader();
			...
			configurationItem.addRadioStation((new RadioStation(e.getChildText("name"), new URL(e.getChildText("address")),
